...
A minimalist, high-performance in-memory key-value storage engine built from scratch using **Modern C++17**. This project demonstrates clean memory management, efficient data structures,and persistence without external dependencies.
...
* **Zero Pointers:** Saafe memory management utilizing RAII principles (no manual `new`/`delete`).
* **CI/CD Ready:** Automated building and testing workflow is ready thanks to tests/
